class AboutMeData {
  ...
  static const paragraph2Part2 =
      " , I am currently working as a Flutter Developer at First Logic Meta Lab Pvt. Ltd., where I continue to expand my expertise in building innovative cross-platform applications. My passion for technology and my commitment to staying updated with the latest trends drive my professional journey.";

  static const paragraph3 =
      "Here are a few technologies I've been working with recently: Bloc, Clean Architecture, Hive.";
}
...
class FooterData {
  ...
  static const contactPart4 = "+91 7356445196";
  static const contactPart5 = ".";
  static const copyright = "© 2023 by Shanul Hakeem T";
}

class IntroData {
  static const greeting = "Hey there, I'm";
  static const name = "Shanul Hakeem T.";
  static const title = "I build mobile and web apps.";
  static const about =
      "I'm a software developer, with a passion for crafting digital experiences. Currently, my focus is on developing a mobile application using Flutter and state management with better architectures. I have experience in developing and maintaining mobile applications using Flutter and Dart, implementing state management and API integration with REST APIs.";
}
...
class FlitData {
  ...
  static const point1Part1 =
      "Contributed to the development of an Project Management Tool System utilizing ";
  static const point1Part2 = " and other relevant technologies.";
  static const point1Part3 = "";
  static const point1Part4 = "";
  static const point2 =
      "Contributed to Flit Online Portal's development, integrating real-time chat and task evaluation using Firebase. Demonstrates expertise in educational tech and platform development, advancing online learning.";

  static const point4 =
      "Collaborated with cross-functional teams to identify and resolvetechnical issue.";
